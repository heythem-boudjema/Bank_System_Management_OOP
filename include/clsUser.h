...
private:
    ...
    string _PreparLoginRecord(string Seperator = "#//#")
    {
       
        string UserRecord="";
        UserRecord += clsDate::GetSystemDateTimeString()+Seperator;
        UserRecord += _UserName + Seperator;
        UserRecord += clsUtil::EncryptText (_Password,4) + Seperator;
...
public:
    ...
    enum enPermissions {
        ...
        pUpdateClients = 8, pFindClient = 16, pTranactions = 32, pManageUsers = 64, pLogScreen = 128
    };
    bool IsEmpty()
    {
    ...
    static stLoginRegisterRecord _ConvertLoginRegisterLineToRecord(string Line, string Seperator = "#//#")
    {
        ...
        vector <string> LoginRegisterDataLine = clsString::SplitByDelimiter(Line);
    ...
    void RegisterLoginInLogFile(string FileName="LogFile.txt")
    {
        fstream MyFile;
        MyFile.open(FileName, ios::out | ios::app);
        ...
        if (MyFile.is_open())
        {
            ...
            MyFile << _PreparLoginRecord() << endl;
    ...
    static  vector <stLoginRegisterRecord> GetLoginRegisterList(string FileName="LogFile.txt")
    {
